...
class Cell{
    ...
    // ~Cell();
    int countBlobs(int rowm, int col, int connection);
...
int Cell::countBlobs(int row, int col, int connection){
    int blob_count = 0;
